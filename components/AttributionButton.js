import React, { ActionSheetIOS, Alert, Image, TouchableOpacity } from 'react-native'
  ...
  render () {
    ...
    return (
      <TouchableOpacity onPress={this.showActionSheet} style={styles.attribution}>
        <Image source={require('../assets/icons/info/info_circle.png')} style={styles.attributionIcon} />
      </TouchableOpacity>
    )
  }
}

AttributionButton.propTypes = {
