import React, { Dimensions, Image, ScrollView, StyleSheet, View } from 'react-native'
...
export default class StationSlider extends React.Component {
  ...
  constructor (props) {
    super(props)
    this.panToStation = this.panToStation.bind(this)
  ...
  componentWillReceiveProps (nextProps) {
    ...
    const scrollView = this.refs.stationScrollView
...
StationSlider.propTypes = {
  ...
  stopCallout0: React.PropTypes.object,
  stopCallout1: React.PropTypes.object,
  stopCallout2: React.PropTypes.object,
  stopCallout3: React.PropTypes.object,
  stopCallout4: React.PropTypes.object,
  stopCallout5: React.PropTypes.object,
  stopCallout6: React.PropTypes.object,
  stopCallout7: React.PropTypes.object,
  stopCallout8: React.PropTypes.object,
  stopCallout9: React.PropTypes.object,
  stopCallout10: React.PropTypes.object,
  stopCallout11: React.PropTypes.object,
  stopCallout12: React.PropTypes.object,
  stopCallout13: React.PropTypes.object,
  stopCallout14: React.PropTypes.object
}
