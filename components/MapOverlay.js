import React, { Alert, Image, SegmentedControlIOS, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
...
export default class MapOverlay extends React.Component {
  ...
  render () {
    ...
    let failText = locationDenied ? 'Location Disabled - Enable' : 'Offline Mode - Try Again'
            ...
            <View style={styles.headerContainer}>
              <TouchableOpacity onPress={Actions.about} style={styles.about}>
                <View style={styles.help}>
                  <Image source={require('../assets/icons/help/ic_help_white.png')} />
                </View>
              </TouchableOpacity>
